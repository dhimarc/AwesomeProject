...
<body>
  ...
  <script>
    ...
    // Layer WMS per tahun
    var wmsLayers = {
      "2013": L.tileLayer.wms('http://10.101.4.140:8080/geoserver/wms', {
      ...
      "2016": L.tileLayer.wms('http://10.101.4.140:8080/geoserver/wms', {
      ...
      "2019": L.tileLayer.wms('http://10.101.4.140:8080/geoserver/wms', {
      ...
      "2022": L.tileLayer.wms('http://10.101.4.140:8080/geoserver/wms', {
      ...
      "2024": L.tileLayer.wms('http://10.101.4.140:8080/geoserver/wms', {
